...
plot(NA,ylab=expression(paste('CG ',Delta,' methylation levels(%)')),xlab=NA,type='l',cex.main = 1,xlim=c(0,ncol(metafile1)),ylim=c(ly_cg,hy_cg),xaxt="n",cex=1.5)
...
plot(NA,ylab=expression(paste('CHG ',Delta,' methylation levels(%)')),xlab=NA,type='l',cex.main = 1,xlim=c(0,ncol(metafile1)),ylim=c(ly_chg,hy_chg),xaxt="n",cex=1.5)
lines(av*100,xlab=NA,type='l',cex.main = 1,xaxt="n",cex=1.5,col=palette()[i])
...
plot(NA,ylab=expression(paste('CHH ',Delta,' methylation levels(%)')),xlab=NA,type='l',cex.main = 1,xlim=c(0,ncol(metafile1)),ylim=c(ly_chh,hy_chh),xaxt="n",cex=1.5)
lines(av*100,xlab=NA,type='l',cex.main = 1,xaxt="n",cex=1.5,col=palette()[i])
