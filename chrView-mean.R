...
#CG
outfile=paste("./chrViewq_mean_CG.png",sep="")
bitmap(outfile,type="png16m",height=2,width=8,res=400)

plot(NA,ylab=expression(paste('CG ',Delta,' methylation levels(%)')),xlab="Chromosome",col='white',pch=19,type='p',cex.main = 1,frame = FALSE,ylim=c(ys_cg,ym_cg),xlim=c(0,nrow(viewfile1)),xaxt="n",cex=1.5)
...
#CHG
outfile=paste("./chrViewq_mean_CHG.png",sep="")
bitmap(outfile,type="png16m",height=2,width=8,res=400)

plot(NA,ylab=expression(paste('CHG ',Delta,' methylation levels(%)')),xlab="Chromosome",col='white',pch=19,type='p',cex.main = 1,frame = FALSE,ylim=c(ys_chg,ym_chg),xlim=c(0,nrow(viewfile1)),xaxt="n",cex=1.5)
...
#CHH
outfile=paste("./chrViewq_mean_CHH.png",sep="")
bitmap(outfile,type="png16m",height=2,width=8,res=400)

plot(NA,ylab=expression(paste('CHH ',Delta,' methylation levels(%)')),xlab="Chromosome",col='white',pch=19,type='p',cex.main = 1,frame = FALSE,ylim=c(ys_chh,ym_chh),xlim=c(0,nrow(viewfile1)),xaxt="n",cex=1.5)
